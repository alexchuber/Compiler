...
public class LexerTests {
	...
	@Test
	void testAAAAAAAAAA() throws LexicalException {
		String input = "REDYELLOWGREEN-";
		show(input);
		ILexer lexer = getLexer(input);
		show(lexer.next().getKind());
		show(lexer.next().getKind());
		show(lexer.next().getKind());
	}
	...
	void AAAAAAAAA() {
		...
		switch (myMood) {
			case SAD: feeling ="dreading";
			case HAPPY: feeling= "looking forward to";
			case MEH: feeling = "going to";
		}

		show("I am " + feeling + " the party.");
